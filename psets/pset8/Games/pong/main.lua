...
function love.draw()
    ...
    if gameState == 'start' then
        ...
        love.graphics.printf('1. Press 1 to Play 1 v 1', 0, 20, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('2. Press 2 to Play 1 v AI', 0, 30, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('3. Press 3 to Play AI v AI', 0, 40, VIRTUAL_WIDTH, 'center')
    ...
    elseif gameState == 'staging' then
        --ui messages
        love.graphics.setFont(smallFont)
        love.graphics.printf('mode' .. tostring(mode), 0, 10, VIRTUAL_WIDTH, 'center')
