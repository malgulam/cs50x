...
function Map:init()
    ...
    while x < self.mapWidth do
        ...
        --generate pyramid + flag when we at the end of a level
        while x == self.mapWidth / 2 + 8 do
            ...
            x =x +3
            self:setTile(x + 1, self.mapHeight / 2-3, MYFAVOURITE_FLAG)
...
function Map:collides(tile)
    ...
    local collidables = {
        ...
        MUSHROOM_TOP, MUSHROOM_BOTTOM, MYFAVOURITE_FLAG
    }
...
function Map:render()
    ...
    if gameState == 'done'  then
        ...
        love.graphics.clear(1,153/255,1,1)
        love.graphics.printf("You  won bih", 0, VIRTUAL_HEIGHT/2, VIRTUAL_WIDTH, 'center')
    end
end
