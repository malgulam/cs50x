...
function Player:update(dt)
    ...
    --display voctory message if player is win
    if self.map:tileAt(self.x, self.y+1).id == MYFAVOURITE_FLAG or self.map:tileAt(self.x, self.y - 1).id == MYFAVOURITE_FLAG then
        gameState = 'done'
    end
end
